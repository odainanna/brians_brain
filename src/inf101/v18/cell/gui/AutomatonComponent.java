...
import inf101.v18.cell.ICellAutomaton;
...
class AutomatonComponent extends Component {
  ...
  /**
   * The size of the space between each cell and between the cell and the edge of the window.
   */
