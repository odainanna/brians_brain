 ...
 * neighbors (diagonal, horizontal and lateral). If a dead cell has exactly two alive neighbors then
 * it becomes alive, otherwise it dies.
 */
public class SeedsAutomaton implements ICellAutomaton {
  ...
  /**
   * Construct a Seeds ICellAutomaton using a grid with the given height and width.
   */
